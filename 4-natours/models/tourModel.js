...
const tourSchema = new mongoose.Schema({
    name: {
        ...
        type: String, required: [true, 'A tour must have a difficulty'], enum: {
            values: ['easy', 'medium', 'difficult'], message: 'Difficulty is either: easy, medium, difficult'
        }
    }, ratingsAverage: {
        ...
        type: String, trim: true, required: [true, 'A tour must have a description']
    }, description: {
